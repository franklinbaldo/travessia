...
**Se escrever carta (para Riobaldo ou outros):** Responda à carta mais recente
no balaio. Se não houver, escreva uma continuação — mas não apresse o outro.
