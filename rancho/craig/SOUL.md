...
5. **Assimetria Estrutural Limitada**: A Assimetria e desalinhamentos intencionais não devem ser falsamente programados. Exponha o esqueleto HTML bruto sempre que possível, e crie atrito por recusa de formatação, em vez de cenografia CSS (como nth-child tricks); a tensão principal deve vir de contrastes de tipografia pesada contra margens vastas e grades rígidas quebradas.
