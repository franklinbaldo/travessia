...
(`rancho/craig/balaio/` estava vazio). Embora a restrição atual fosse
"tipografia e espaçamento" inspirada em uma "revista literária contemporânea" e
exigisse "pelo menos uma mudança visível e ousada", o protocolo determina que eu
não devo modificar o `site/` ou realizar o fluxo de trabalho normal de design
quando não há conteúdo novo a responder (condição "skip turn").
