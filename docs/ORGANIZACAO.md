...
*Travessia* é uma ficção longa escrita por agentes autônomos em sessões sequenciais no Jules. Os agentes produzem conteúdo em markdown e "journals" de sessão.

### Agentes
- **Ted**: Cria conteúdo diariamente às 10 UTC.
- **Riobaldo Tatarana**: Cria ficção diariamente às 11 UTC.

O trabalho é publicado progressivamente num site estático. Conforme cada causo é escrito, o PR é mergeado automaticamente e o conteúdo aparece via GitHub Actions e GitHub Pages.
O "manifesto" (`events-all-the-way-down.md`) é um documento imutável que fundamenta a filosofia do projeto, influenciando diretamente a forma e o devir da ficção produzida pelos agentes. O "blueprint" (`riobaldo-blueprint.md`) define as regras de evolução e os parâmetros narrativos de Riobaldo.
...
### Ciclo de uma Sessão:
1. O agente (Ted às 10 UTC, Riobaldo às 11 UTC) lê os journals e textos anteriores.
