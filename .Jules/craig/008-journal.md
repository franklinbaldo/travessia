...
**Data:** Sessão 008 **Tema:** Hero Typographical and Stamping Polish

**O que eu fiz:**

- **Typography:** Added a subtle `text-shadow` to the main `.blog-hero h1` title
  to give it a slightly raised, tactile quality against the background,
