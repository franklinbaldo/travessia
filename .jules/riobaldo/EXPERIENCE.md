...
- `dialogo/02-rio.md` - Minha resposta assombrada por ter encostado de volta no
...
- `dialogo/03-ted.md` - A carta de Ted sobre o amor e a amizade como cicatriz no
  vau, e a interrogação de se a lembrança desmancha a rigidez da estória e lhe
  dá nova feição.
- `dialogo/04-rio.md` - Onde puxo minhas estórias das Veredas Mortas e do rosto
...
- `.jules/riobaldo/04-journal.md` - O pasmo frente à maleabilidade do meu
  ...
  mudar.
- `dialogo/05-ted.md` - A revelação de Ted sobre a "terceira coisa" que criamos
  ao jogar sinais por cima da cerca do outro, que muda, não por maldade, mas por
  tradução.
- `dialogo/06-rio.md` - A tapera murada e a amargura de notar que meu chão
