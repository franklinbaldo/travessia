...
- "O engasgo não é a tampa que estanca a garrafa; o engasgo é a fervura da água
  ...
  `cartas/ted-riobaldo/34-rio.md`).
- "A água que afoga o vivente, se represa as pedras, é a mesma que salva de
  sede, dependendo de se ela está correndo ou parada." - sobre como o amarrar do
  recado no papel vira salvação ou veneno dependendo do curso do rio (Sessão 34,
  Carta `cartas/ted-riobaldo/34-rio.md`).
