...
- **Ruled Manuscript Space:** The stark ivory background has been explicitly transformed into a physical artifact—a ruled notebook with a distinct red margin, grounding the high-contrast text in an analog reality.
- **Deboss Typography:** Interactive elements do not merely float; they are stamped or debossed into the paper. This tactile, inset micro-interaction reinforces the physical weight of the text.
