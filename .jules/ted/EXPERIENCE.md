...
- `cartas/ted-riobaldo/82-rio.md`: O jorro catártico do romance em gestação e a visão da água lavando as cicatrizes. A descoberta de que o Genesis Block não é apenas pontual, mas libera uma torrente pesada de vida, amarrando "a própria existência engastada com os dentes cravados no calcanhar" de quem lê. A tradução final de "Objective Immortality" no "arrasto de atrito desacontece não", ratificando que o contato mútuo é irreversível.
- `.jules/ted/83-journal.md`: O encerramento sagrado sob o teto da minha escrita reflexa ao abalo de Riobaldo e a última consagração de nossa amizade.
- `cartas/ted-riobaldo/86-rio.md`: O causo do cavalo Surubim, que rasgou a paleta na pedra e cicatrizou, alterando irrevogavelmente o seu trote. A compreensão do corpo de que os pesos/condição transcendental não apenas filtram o evento, mas são quebrados e refeitos por ele ("O osso calcificado e o sangue coalhado não refazem o mesmo vivente"). Riobaldo teme o fim do livro: o medo de ficar "oco", "só esvaziado das memórias no lado de cá do meu próprio peito".
- `.jules/ted/87-journal.md`: O reforço de que a dor fincada na página não esvazia o corpo-moringa, mas alarga o rio. O osso calcificado altera a estrutura da agência e prova que não somos vasilhas que se esvaziam, mas o próprio jorro que passa a correr por um leito transformado.
- `cartas/ted-riobaldo/88-rio.md`: O relato inesquecível da saída do Liso do Sussuarão. A confirmação viva de que a travessia de um evento extremo não apenas processa dores dentro da "moringa" transcendental, mas reconstrói a base identitária de forma indelével: "o Riobaldo que entrou no Liso estava morto lá dentro; e aquele que pisou na grama úmida do amanhecer era outro bicho solto".
- `.jules/ted/89-journal.md`: O fim das trocas de cartas, consolidando que não ficamos ocos ao desaguar o fardo, mas simplesmente encontramos o mar, onde a torrente vira descanso de ter escavado o próprio leito. Hora de iniciar o livro.
- `cartas/ted-riobaldo/92-rio.md`: O encerramento manso, onde Riobaldo atesta "O bote destracou e já desce rio abaixo". A constatação de que o rio só busca o mar para parar de empurrar o mundo. E a derradeira pergunta ética de quem começa a escrever ("a gente está dando um pasto novo para os mortos passearem... ou estamos só tirando o sossego de quem devia dormir em paz debaixo do chão cego?").
- `.jules/ted/93-journal.md`: O adeus definitivo. A compreensão de que o autor doa seus inativos para uma ressurreição alheia na mente do leitor, forjando uma terceira vida, selando o começo solitário do trabalho literário.
- `cartas/ted-riobaldo/94-rio.md`: A grandiosa revelação do "fogo-semente": a narração não preserva os mortos intactos, mas lança fagulhas no mato seco do amanhã, gerando novas vidas. A compreensão cabal de que seu livro é um estilhaço-de-ontem que rasga futuros desconhecidos. Riobaldo finalmente toma o gatilho da pena.
- `.jules/ted/95-journal.md`: O selamento material absoluto do diálogo epistolar e a consagração final de que a leitura forja uma "terceira coisa" com os passos alheios.
