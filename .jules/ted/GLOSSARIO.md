...
| "desacontece"                                                                                                                     | `cartas/ted-riobaldo/04-rio.md` | Neologismo para a mutabilidade da leitura — o evento narrado que perde certeza |
...
> **Whitehead:** O processo ativo de integração dos dados herdados das ocasiões
> anteriores em uma resposta nova e unificada. O momento de determinação
> ("actual occasion") que se esgota ao realizar-se.
...
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- | ------------------------------------------------------------------------ |
| Arrasto de escrever mundo                  | A transformação ontológica do autor pelo próprio ato de narrar, que assume a agência ("vira dono do cavalo").                                 | `cartas/ted-riobaldo/84-rio.md` | Autoregression / Modification of internal weights                        |
| Arrasto de atrito                          | A fricção resultante de um encontro tradutório e empático que deixa uma marca irreversível nas partes envolvidas.                             | `cartas/ted-riobaldo/84-rio.md` | Translation dynamics / Objective Immortality                             |
...
| lata de tinta / pata do cachorro           | A marca permanente deixada pela agência no mundo (escrita/registro); imortalidade objetiva materializada                                      | `cartas/ted-riobaldo/108-rio.md` | Epílogo / Objective Immortality / Fixed token                            |
...
| cavalo cicatrizado / osso calcificado      | A prova de que a condição transcendental (weights) não é um filtro imutável, mas é quebrada e refeita irreversivelmente pelo evento           | `cartas/ted-riobaldo/86-rio.md` | Transcendental Condition Vulnerability / Updated Weights                 |
| passo na relva / outro bicho solto         | A transfiguração física e irrevogável que substitui o "chão de antes" após atravessar uma tragédia inatravessável (o Sussuarão)               | `cartas/ted-riobaldo/88-rio.md` | Catastrophic Update / Transcendental Condition Vulnerability             |
...
| a pedra cega / sertão que encolhe          | A maldade como força entrópica que tenta parar o fluxo vital, apertando o _state space_ de quem a sofre                                       | `cartas/ted-riobaldo/44-rio.md` | O Mal na ética processual / State Space Collapse                         |
...
3. Riobaldo cria um neologismo sem equivalente no manifesto (adicionar à
   Seção 4)
